...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (!preg_match("/^[a-zA-Z ]{1,100}$/", $product)) {
    ...
    try {
       ...
       $mail->isSMTP();
        ...
        // Email content
        $mail->isHTML(true);
        $mail->Subject = 'Enquery Form Received';
        $mail->Body    = "<table width='680' cellspacing='5' cellpadding='5' style='border:2px solid #000;'>
            <tr><td colspan='2' align='center' width='680' style='font-size:20px;border:1px solid #000;'>Enquery Form </td></tr>
            <tr bgcolor='#f2f2f2'><td width='400' align='left'>Product Name</td><td width='280' align='center'>$product</td></tr>
            ...
            <tr bgcolor='#f2f2f2'><td width='400' align='left'>State</td><td width='280' align='center'>$state</td></tr>
